...
public class OrdersGUI {
    ...
    public void displayOrdersForm(PizzaService service){
     VBox verticalBoxThatContainsOrders = null;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/OrdersGUIFXML.fxml"));

            //verticalBoxThatContainsOrders = FXMLLoader.load(getClass().getResource("/fxml/OrdersGUIFXML.fxml"));
            verticalBoxThatContainsOrders = loader.load();
     ...
     stage.setScene(new Scene(verticalBoxThatContainsOrders));
     stage.show();
    }
}
